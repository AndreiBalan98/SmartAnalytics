...
export default function HeroSection() {
  return (
    <section className="min-h-screen bg-navy-gradient flex items-center justify-center px-4 py-20">
      <div className="max-w-6xl mx-auto text-center">
        ...
        >
          ...
          >
            <span className="px-4 py-2 bg-electric-blue/10 border border-electric-blue/30 rounded-full text-electric-blue text-sm font-medium">
          ...
          >
            ...
            >
              <span className="text-xs uppercase tracking-wider font-medium">Descoperă</span>
              <motion.div
                animate={{
                  y: [0, 10, 0],
                }}
